...
FILTER_TERRAIN = 16
FILTER_OBJECT_ALL = bit32.bor(FILTER_OPAQUE, FILTER_TRANSPARENT, FILTER_WATER, FILTER_NAVIGATION_MESH, FILTER_TERRAIN)
FILTER_COLLIDER = 32
FILTER_RAGDOLL = 64
FILTER_ALL = bit32.bnot(0)
...
void Bind()
{
	...
	if (!initialized)
	{
		...
		wi::lua::RunText(value_bindings, "Scene_value_bindings");
	}
}
