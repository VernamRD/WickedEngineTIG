...
namespace Giperion
{
    namespace Compute
    {
        TaskHandle::TaskHandle::TaskHandle(const TaskPtr& task)
        {
        ...
        const wi::vector<TaskHandle>& TaskHandle::GetPrerequisites() const
        {
        ...
        TaskHandle Task::InitHandle(TaskPtr thisPtr) const
        {
